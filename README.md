...
This repository designs a forkable OSS business for other human health activities -- allied health services (physiotherapy, chiropractic, optometry, ambulance and paramedical services) not classified as hospital or physician practice -- run by a qualified, licensed operator so a community or
...
the physical domain work**. Here a mobility-assist robot supports physical patient transfer/therapy exercises,
under an actor that proposes actions and an independent **Allied Health Governor**
...
approval and audit evidence: administering a treatment session.

## Capability layer

This blueprint resolves its technology stack via
[`kotoba-lang/industry`](https://github.com/kotoba-lang/industry) (ISIC
`8690`). This vertical's care/case records are practice-specific rather
...
The governed actor implementation (`AlliedHealth-LLM` + `Allied Health Governor` as
